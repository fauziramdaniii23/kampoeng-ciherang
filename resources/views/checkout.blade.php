  ...
  <body>
    ...
    <div class="d-flex justify-content-center align-items-center" style="height: 100vh">
        <div class="card px-4 py-4 shadow">
          ...
          <h6 class="card-subtitle mb-2 text-body-secondary">Reservasi</h6>
          ...
          <p class="card-text">Total Harga : Rp.{{ $order->total_price }}</p>
          <p class="card-text">Tanggal pesanan: {{ $order->created_at }}</p>
